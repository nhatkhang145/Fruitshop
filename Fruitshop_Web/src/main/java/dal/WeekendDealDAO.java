...
public class WeekendDealDAO {
    ...
    /**
     * Lấy deal đang active theo product ID
     */
    ...
    /**
     * Lấy Map tất cả deals đang active theo productId
     * Dùng để hiển thị giá weekend deal trên card sản phẩm
     */
    public java.util.Map<Integer, WeekendDeal> getActiveDealsByProductIds() {
        ...
        // Convert List to Map<ProductId, WeekendDeal>
