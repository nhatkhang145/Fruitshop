...
public class WeekendDealDAO {
    ...
    /**
     * Lấy tất cả deals đang active
     */
    public List<WeekendDeal> getActiveDeals() {
        String sql = "SELECT wd.id, wd.product_id, wd.title, wd.subtitle, wd.discount_percent, " +
     ...
     * Thêm deal mới
     */
    public int insert(WeekendDeal deal) {
        String sql = "INSERT INTO weekend_deals (product_id, title, subtitle, discount_percent, " +
                     "start_date, end_date, status, sort_order) " +
                     "VALUES (:productId, :title, :subtitle, :discountPercent, :startDate, :endDate, :status, :sortOrder)";
     ...
     * Cập nhật deal
     */
    public int update(WeekendDeal deal) {
        String sql = "UPDATE weekend_deals SET product_id = :productId, title = :title, subtitle = :subtitle, " +
    ...
    /**
     * RowMapper cho WeekendDeal với Product
     */
