 ...
 <jsp:include page="header.jsp"></jsp:include>
  <div class="breadcrumb">
    <div class="container">
      ...
      <a href="/orders.jsp">Đơn mua</a> &gt; <span>Chi tiết đơn hàng</span>
    </div>
  </div>
        ...
        <main class="profile-content order-detail-content">
          <div class="detail-header">
            <div class="header-left">
              <a href="/orders.jsp" class="btn-back"><i class="fa-solid fa-chevron-left"></i> Trở lại</a>
              <span class="detail-id">Đơn hàng #12345</span>
              <span class="detail-divider">|</span>
              <span class="detail-status status-completed">Hoàn thành</span>
            </div>
          </div>
          ...
          <div class="detail-info-grid">
            ...
            <div class="info-card">
              ...
              <div class="info-content">
                ...
                <p class="shipping-carrier">Đơn vị: Giao Hàng Nhanh</p>
                <p class="tracking-code">Mã đơn hàng: GHN12345</p>
              </div>
            </div>
          </div>
          ...
          <div class="order-card detail-product-list">
            <div class="order-card__body" style="padding-top: 10px; padding-bottom: 10px">
              <div class="order-item">
                ...
                <div class="item-info">
                  <h4 class="item-name">Dừa sáp Trà Vinh (Loại 1)</h4>
              ...
              <div class="order-item">
                <img src="https://botanica.risingbamboo.com/wp-content/uploads/2023/06/bn6-1.png" alt="Product"
                  class="item-thumb" />
                <div class="item-info">
                  <h4 class="item-name">Cam Sành Vĩnh Long</h4>
          ...
          <div class="detail-summary">
            ...
            <div class="summary-row total">
              ...
              <span class="total-price">350.000đ</span>
            </div>
            <div class="payment-method">
              <i class="fa-solid fa-money-bill-wave"></i> Phương thức thanh
              toán: Thanh toán khi nhận hàng (COD)
            </div>
          </div>

          <div class="detail-actions">
            <a href="contact.jsp" class="btn btn-outline">Liên hệ Shop</a>
