      ...
      <div class="detail-grid">
        ...
        <div class="left-col">
          ...
          <div class="card">
            ...
            <div class="action-bar" style="justify-content: center; margin-top: 10px;">
              <button type="submit" class="btn btn-save" style="width: 100%;">
        ...
        <div class="right-col">
          ...
          <div class="card">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="${user.phone != null ? user.phone : 'Chưa cập nhật'}" readonly>
              </div>
              <div class="form-group">
                <label>Giới tính</label>
                <input type="text" class="form-control" value="${user.gender != null ? user.gender : 'Chưa cập nhật'}" readonly>
              </div>
              <div class="form-group">
                <label>Ngày sinh</label>
                <input type="text" class="form-control"
                       value="<fmt:formatDate value='${user.birthDate}' pattern='dd/MM/yyyy'/>" readonly>
              </div>
              <div class="form-group">
                <label>Social ID</label>
                <input type="text" class="form-control" value="${user.socialId != null ? user.socialId : 'Không'}" readonly>
              </div>
            </div>
          </div>
            ...
            <c:choose>
              ...
              <c:otherwise>
                <div class="empty-state">
                  <i class='bx bx-map-pin' style="font-size: 48px; margin-bottom: 10px;"></i>
          ...
          <div class="action-bar">
            <a href="users" class="btn btn-cancel">Quay lại danh sách</a>
          </div>
        </div>
      </div>
    </form>
