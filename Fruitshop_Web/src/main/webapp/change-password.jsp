...
<body>
    ...
    <div class="breadcrumb">
        <div class="container">
            <a href="index.jsp">Trang chủ</a> &gt; <span>Đổi mật khẩu</span>
        </div>
    </div>
        ...
        <div class="container">
            <div class="profile-container">
                ...
                <main class="profile-content">
                    <div class="profile-header">
                        ...
                        <c:if test="${not empty requestScope.error}">
                            <div style="background-color: #f8d7da; color: #721c24; padding: 10px; border-radius: 5px; margin-top: 10px; border: 1px solid #f5c6cb;">
                                <i class="fa-solid fa-triangle-exclamation"></i> ${requestScope.error}
                            </div>
                        </c:if>
                    ...
                    <form class="profile-form password-change-form" action="change-password" method="post">
