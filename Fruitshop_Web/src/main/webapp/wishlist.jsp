...
<html lang="en">
  <head>
    ...
    <title>Sản phẩm yêu thích - Organic Harvest</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="breadcrumb">
      <div class="container">
        <a href="/">Trang chủ</a> &gt;
        <a href="/profile.jsp">Tài khoản</a> &gt; <span>Yêu thích</span>
      </div>
    </div>
        ...
        <div class="profile-container">
          ...
          <main class="profile-content">
            <div class="wishlist-header">
              ...
              <span class="wishlist-count">3 sản phẩm</span>
            </div>

            <div class="wishlist-grid">
              <div class="wishlist-item">
                <button class="btn-remove" title="Xóa khỏi yêu thích">
                ...
                <div class="wishlist-info">
                  <a href="#" class="wishlist-name"
                    >Dừa sáp Trà Vinh loại 1 thơm ngon béo ngậy</a
                  >
                  <div class="wishlist-price">
                    <span class="new">120.000đ</span>
                    <span class="old">200.000đ</span>
                  </div>
              ...
              <div class="wishlist-item">
                ...
                <div class="wishlist-img">
                  <img
                    src="https://botanica.risingbamboo.com/wp-content/uploads/2023/06/bn6-1.png"
                    alt="Cam"
                  />
                </div>
                <div class="wishlist-info">
                  <a href="#" class="wishlist-name">Cam Sành Vĩnh Long</a>
                  <div class="wishlist-price">
              ...
              <div class="wishlist-item disabled">
                <button class="btn-remove" title="Xóa khỏi yêu thích">
                  <i class="fa-solid fa-xmark"></i>
                </button>
                <div class="wishlist-img">
                  <img src="https://via.placeholder.com/200" alt="Nho" />
                  <div class="overlay-out">Hết hàng</div>
                </div>
                <div class="wishlist-info">
                  <a href="#" class="wishlist-name">Nho Mẫu Đơn Hàn Quốc</a>
                  <div class="wishlist-price">
                    <span class="new">450.000đ</span>
                  </div>
                  <div class="wishlist-status out-stock">
                    <i class="fa-solid fa-circle-xmark"></i> Hết hàng
                  </div>
                  <button class="btn btn-cart" disabled>Hết hàng</button>
                </div>
              </div>
            </div>
          </main>
