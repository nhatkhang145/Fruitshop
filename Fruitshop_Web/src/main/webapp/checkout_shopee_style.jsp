                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <div class="billing-form__group">
                                                ...
                                                <input class="billing-form__input" type="text" id="fullname"
                                                    name="fullname" value="${user.fullName}" required>
                                            </div>
                                            <div class="billing-form__group">
                                                <label class="billing-form__label" for="phone">Số điện thoại *</label>
                                                <input class="billing-form__input" type="tel" id="phone" name="phone"
                                                    value="${user.phone}" required>
                                            </div>
                                            <div class="billing-form__group">
                                                <label class="billing-form__label" for="address">Địa chỉ nhận hàng
                                                    *</label>
                                                <textarea class="billing-form__input billing-form__input--textarea"
