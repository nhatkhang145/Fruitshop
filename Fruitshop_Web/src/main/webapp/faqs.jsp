...
<html lang="vi">
  <head>
    ...
    <title>Hỗ Trợ & FAQs — The Organic Harvest</title>
      ...
      <main class="faqs-page">
        <div class="breadcrumb">
          <div class="grid">
            ...
            <span>Hỗ Trợ & FAQs</span>
          </div>
        </div>

        <div class="faqs-container grid">
          <h1 class="section-title">Câu Hỏi Thường Gặp (FAQs)</h1>

          <h2 class="faq-category">Về Đặt Hàng & Thanh Toán</h2>
          <div class="faq-list">
            <details class="faq-item">
              <summary class="faq-question">
                Làm thế nào để đặt hàng qua website?
              </summary>
              <div class="faq-answer">
                <p>
                  Bạn chỉ cần chọn sản phẩm, thêm vào giỏ hàng, và điền thông
                  tin nhận hàng tại trang thanh toán. Chúng tôi sẽ gọi điện xác
                  nhận đơn hàng của bạn ngay sau đó.
                </p>
              </div>
            </details>
            <details class="faq-item">
              <summary class="faq-question">
                Shop chấp nhận những hình thức thanh toán nào?
              </summary>
              <div class="faq-answer">
                <p>Chúng tôi chấp nhận 2 hình thức thanh toán chính:</p>
                <ul>
                  <li>Thanh toán khi nhận hàng (COD).</li>
                  <li>
                    Chuyển khoản ngân hàng (Vui lòng ghi mã đơn hàng trong nội
                    dung chuyển khoản).
                  </li>
                </ul>
              </div>
          ...
          <h2 class="faq-category">Vận Chuyển & Giao Hàng</h2>
          <div class="faq-list">
            <details class="faq-item">
              <summary class="faq-question">
              ...
              <div class="faq-answer">
                <p>
                  Đối với các đơn hàng nội thành TP.HCM, chúng tôi hỗ trợ giao
                  hỏa tốc trong 2 giờ. Đối với các tỉnh thành khác, thời gian
                  giao hàng dự kiến từ 2-4 ngày làm việc.
                </p>
              </div>
            </details>
            <details class="faq-item">
              ...
              <div class="faq-answer">
                <p>
                  Chúng tôi miễn phí vận chuyển cho các đơn hàng từ 500.000đ.
                  Với các đơn hàng dưới 500.000đ, phí vận chuyển đồng giá
                  25.000đ cho nội thành và 35.000đ cho các khu vực khác.
                </p>
              </div>
            </details>
          </div>

          <h2 class="faq-category">Chính Sách Đổi Trả</h2>
          <div class="faq-list">
            <details class="faq-item">
              <summary class="faq-question">
                Tôi có thể đổi trả sản phẩm nếu không hài lòng không?
              </summary>
              <div class="faq-answer">
                <p>
                  Vì trái cây là mặt hàng tươi sống, chúng tôi chỉ chấp nhận đổi
                  trả trong vòng 24 giờ nếu sản phẩm bị dập, hỏng hoặc không
                  đúng chất lượng như cam kết. Vui lòng chụp ảnh sản phẩm và
                  liên hệ ngay với fanpage hoặc hotline để được hỗ trợ.
                </p>
              </div>
            </details>
          </div>
