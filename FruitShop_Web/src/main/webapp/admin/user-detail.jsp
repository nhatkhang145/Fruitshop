              ...
              <table class="user-detail__order-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>450,000đ</td>
                    <td>
                      <a href="/admin/order-detail.jsp?id=12345" class="action-btn view"><i class="bx bx-show"></i></a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>1,200,000đ</td>
                    <td>
                      <a href="/admin/order-detail.jsp?id=12301" class="action-btn view"><i class="bx bx-show"></i></a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>300,000đ</td>
                    <td>
                      <a href="/admin/order-detail.jsp?id=12250" class="action-btn view"><i class="bx bx-show"></i></a>
                    </td>
                  </tr>
                </tbody>
              </table>
