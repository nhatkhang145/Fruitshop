...
<html lang="vi">
  <head>
    ...
    <title>Về Chúng Tôi — The Organic Harvest</title>
            ...
            <div class="navbar__content">
              ...
              <ul class="navbar-list">
                <li class="navbar-item">
                  <a href="faqs.jsp" class="navbar-item__link">
          ...
          <div class="navbar__menu">
            <div class="navbar__menu-inner">
              ...
              <div class="navbar__menu-actions">
                ...
                <a href="/cart.jsp" class="icon-btn cart-btn" title="Giỏ hàng">
        ...
        <div class="about-section grid">
          <div class="about-image">
            <img
              ...
              alt="Cửa hàng trái cây"
            />
          </div>
          <div class="about-content">
            <h1 class="about-title">Câu Chuyện Của Organic Harvest</h1>
            <p class="about-subtitle">
              Mang Nguồn Dinh Dưỡng Tươi Sạch Đến Mọi Nhà
            </p>
            <p>
              Organic Harvest được thành lập với một niềm tin đơn giản: mọi
              người đều xứng đáng được thưởng thức những loại trái cây tươi
              ngon, an toàn và bổ dưỡng nhất. Chúng tôi bắt đầu từ một cửa hàng
              nhỏ, làm việc trực tiếp với các nông dân địa phương để tuyển chọn
              những sản phẩm chất lượng nhất.
            </p>
            <p>
              Ngày nay, Organic Harvest đã phát triển thành một thương hiệu đáng
              tin cậy, cung cấp trái cây nhập khẩu và nội địa đạt chuẩn, giao
              hàng nhanh chóng đến tận tay khách hàng. Sứ mệnh của chúng tôi là
              làm cho việc ăn uống lành mạnh trở nên dễ dàng và thú vị hơn.
            </p>
          </div>
        </div>
          ...
          <div class="grid">
            ...
            <div class="values-grid">
              <div class="value-item">
                ...
                <h3>100% Tươi Sạch</h3>
                <p>
                  Chúng tôi cam kết trái cây luôn tươi mới khi đến tay bạn, được
              ...
              <div class="value-item">
                ...
                <p>
                  Hệ thống giao hàng hỏa tốc đảm bảo bạn nhận được sản phẩm chỉ
                  trong vài giờ đặt hàng.
                </p>
              </div>
              <div class="value-item">
                ...
                <p>
                  Tất cả sản phẩm đều có nguồn gốc rõ ràng, tuân thủ nghiêm ngặt
