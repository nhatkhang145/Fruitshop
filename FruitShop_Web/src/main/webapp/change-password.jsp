  ...
  <body>
   ...
   <jsp:include page="header.jsp"></jsp:include>
    <div class="breadcrumb">
      <div class="container">
        <a href="/">Trang chủ</a> &gt; <span>Đổi mật khẩu</span>
      </div>
    </div>
      ...
      <div class="container">
        <div class="profile-container">
          ...
          <main class="profile-content">
            ...
            <form class="profile-form password-change-form">
              <div class="profile-form-left" style="padding-right: 0">
                <div class="form-group">
                  ...
                  <div class="password-input-wrapper">
                    ...
                    />
                    <i
                      class="fa-regular fa-eye-slash toggle-password"
                      toggle="#currentPass"
                    ></i>
                  </div>
                </div>
                ...
                <button type="button" class="btn btn-save">Xác nhận</button>
              </div>
            </form>
          </main>
        </div>
    ...
    <script>
      ...
      toggleIcons.forEach((icon) => {
        icon.addEventListener("click", function () {
          // Lấy input tương ứng dựa trên thuộc tính 'toggle'
