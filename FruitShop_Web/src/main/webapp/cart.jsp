        ...
        <main class="cart-wrapper">
          <div class="cart-main">
            <div class="shipping-progress-bar">
              <p>
                Mua thêm <strong>69.000đ</strong> nữa để được
                <strong>miễn phí vận chuyển</strong>
              </p>
              <div class="progress-track">
                <div class="progress-filled" style="width: 54%"></div>
              </div>
            </div>
              ...
              <tbody>
                <tr>
                  <td class="product-cell">
                    <img
                      src="https://ik.imagekit.io/8tm3umulk/image/s%E1%BA%A3n%20ph%E1%BA%A9m/mangcut?updatedAt=1762463418983"
                      alt="Măng Cụt"
                    />
                    <span>Măng cụt</span>
                  </td>
            ...
            <div class="cart-totals">
              ...
              <div class="shipping-section">
                ...
                <label class="shipping-option">
                  ...
                  Giao Hoả Tốc: <strong>50.000đ</strong>
                </label>
                <label class="shipping-option">
                  <input type="radio" name="shipping" />
                  Giao Nhanh: <strong>30.000đ</strong>
                </label>
                <p class="shipping-note">
                  Phương thức giao hàng sẽ được cập nhật khi thanh toán.
                </p>
                <a href="#" class="calculate-shipping">Cập nhật chi phí</a>
              </div>
