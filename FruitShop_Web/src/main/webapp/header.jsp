...
<%
    ...
    java.util.List<model.Category> listCats = catDao.getAllCategories();
                ...
                <ul class="navbar-list">
                    <li class="navbar-item">
                        <a href="${pageContext.request.contextPath}/faqs.jsp" class="navbar-item__link">
                            <span class="navbar-icon__link"><i class="navbar-icon fa-regular fa-circle-question"></i></span>
                            Hỗ trợ
                        </a>
                    </li>
                        ...
                        <c:otherwise>
                            <li class="navbar-item">
                                <span class="navbar-item__link" style="cursor: default;">
                                    <%-- Lưu ý: User model dùng fullName chứ không phải username --%>
                                    <i class="fa-regular fa-user"></i> Xin chào, ${sessionScope.account.fullName}
                                </span>
                            </li>
                        </c:otherwise>
                    </c:choose>
        ...
        <div class="navbar__menu">
            <div class="navbar__menu-inner">
                ...
                <ul class="main-nav-links subnav-links">
                    ...
                    <li><a href="${pageContext.request.contextPath}/shop.jsp">Tất cả sản phẩm</a></li>

                    <c:forEach items="${listCats}" var="c">
                        <li>
                            <a href="${pageContext.request.contextPath}/shop.jsp?cid=${c.id}">${c.name}</a>
                        </li>
                    </c:forEach>
                ...
                <div class="navbar__menu-search">
                    <form class="search-form" action="${pageContext.request.contextPath}/shop.jsp" method="get" role="search">
                        <select name="cid" class="search-cat" aria-label="Category">
                            <option value="0">Tất cả danh mục</option>
                            <c:forEach items="${listCats}" var="c">
                                <option value="${c.id}">${c.name}</option>
                            </c:forEach>
                        </select>
                        <input name="q" class="search-input" type="search" placeholder="Tìm kiếm sản phẩm..." aria-label="Search" />
                ...
                <div class="navbar__menu-actions">
                    ...
                    <div class="header__account">
                        ...
                        <div class="account-dropdown">
                            <%-- Logic hiển thị Dropdown Account --%>
                            <c:if test="${sessionScope.account == null}">
                                <div class="account-auth">
                                    <span class="auth-text">Chào khách, vui lòng:</span>
                                    <div class="auth-buttons">
                                        <a href="login.jsp" class="btn--primary" style="display: block; text-align: center; text-decoration: none; margin-bottom: 8px;">Đăng nhập</a>
                                        <a href="register.jsp" class="btn--outline" style="display: block; text-align: center; text-decoration: none;">Đăng ký</a>
                                    </div>
                                </div>
                            </c:if>
                            ...
                            <c:if test="${sessionScope.account != null}">
                                <div class="account-user">
                                    <div class="user-info">
                                        <img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" alt="User Avatar" class="user-avatar">
                                    ...
                                    <ul class="account-menu">
                                        <li><a href="profile.jsp"><i class="fa-solid fa-id-card"></i> Hồ sơ cá nhân</a></li>
